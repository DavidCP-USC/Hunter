...
public class AnhadirEmpresa extends javax.swing.JFrame {
    
    private boolean bLogout = false;
    private boolean bHome = false;
    private boolean bcreate = false;
        
    public AnhadirEmpresa() {
        initComponents();
    }
    
    public EmpresasVendedoras getDatos(){
        if(DAOManager.empresas().getLastId() != null)
            return new EmpresasVendedoras(DAOManager.empresas().getLastId()+1, nombre.getText(), nombreUsuario.getText(), contrasena.getText(), esAdmin.isSelected(), Date.valueOf(asociacion.getText()));
        else
            return new EmpresasVendedoras(1, nombre.getText(), nombreUsuario.getText(), contrasena.getText(), esAdmin.isSelected(), Date.valueOf(asociacion.getText()));
    }
    ...
    public void createdSuccesfull(){
        saveStatus.setText("Empresa creada correctamente");
    }
    
    public void createdUnnownError(){
        saveStatus.setText("Error creando la empresa (SQL)");
    }
    ...
    private void initComponents() {
        ...
        bg.add(asociacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(425, 372, 340, 40));
        ...
        bg.add(esAdmin, new org.netbeans.lib.awtextra.AbsoluteConstraints(426, 448, 25, 25));
        ...
        bg.add(saveStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 440, 380, 50));

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/anhadirEmpresa.png"))); // NOI18N
