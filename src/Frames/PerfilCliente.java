...
public class PerfilCliente extends javax.swing.JFrame {
    ...
    public PerfilCliente(Clientes c) {
        initComponents();
        Cliente = c;
        setDatos();
    }
    ...
    public final void setDatos(){
        ...
        contrasena.setText(Cliente.getContrasenha());
        telefono.setText(Cliente.getTelefono());
    }
    
    public Clientes getDatos(){
        return new Clientes(Cliente.getIdCliente(), nombre.getText(), nombreUsuario.getText(), contrasena.getText(), Cliente.getEsAdmin(), telefono.getText(), Cliente.getFechaNacimiento());
    }
    ...
    public void modifiedUnnownError(){
        saveStatus.setText("Error modificando el cliente (SQL)");
    }
    ...
    private void initComponents() {
        ...
        bg.add(telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(424, 420, 340, 40));
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/PerfilCliente.png"))); // NOI18N
