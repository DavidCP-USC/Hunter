...
public class EliminarEmpresa extends javax.swing.JFrame {
    ...
    public void deletedSuccesfull(){
        deleteStatus.setText("Empresa eliminada correctamente");
    }
    ...
    public void notRegisteredError(){
        deleteStatus.setText("Error, la empresa no está registrada");
    }
    ...
    private void initComponents() {
        ...
        bg.add(deleteStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 420, 400, 40));

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/eliminarEmpresa.png"))); // NOI18N
